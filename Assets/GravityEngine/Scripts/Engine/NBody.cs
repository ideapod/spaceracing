...
public class NBody : MonoBehaviour, IComparer<NBody> {
	...
	//! Physics velocity used in GE (adjusted for the units/scale chosen by Gravity Engine)
    ...
    /// <summary>
    /// Used to determine the initial physics position of an NBody. 
    /// 
    ...
    ///
    /// If the NBody has an engine ref (i.e. GE has taken charge) then update with the position from GE.    /// </summary>
    /// <param name="ge"></param>
    ...
    /// 
    /// This is only called from editor scripts when a scale update has occured in the GE inspector. Not for
    /// general use!
    /// 
    /// </summary>
